...
I developed a desktop application for Mac. Now I am working on converting in to a chrome application since that would be smaller in size, more updates on it later. Check out the snapshot in the mean time. 
